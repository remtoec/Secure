...
zh: {
  ...
  "landing.eyebrow": "書識圈 ×《Secure》· 一場自我探索",
  "landing.title": "每段關係，都有自己的座標",
  "landing.poem": "傳說裏，有一條看不見的線，把你和你重視的人繫在一起。這裏，我們試着把這些線畫出來——看看每一條線，此刻停在甚麼位置。",
...
en: {
  ...
  "landing.eyebrow": "Bookfort × Secure · a journey inward",
  "landing.title": "Every relationship has its own coordinates",
  "landing.poem": "They say an invisible thread ties you to the people who matter to you. Here, we try to draw those threads — and see where each one rests, right now.",
  ...
  "landing.start": "Begin the journey →",
  ...
  "styles": {
    secure:  {name:"Secure", essence:"You can come close, and still be yourself.",
    ...
    anxious: {name:"Anxious", essence:"You love deeply — and fear losing it just as deeply.",
    ...
    avoidant:{name:"Avoidant", essence:"Space is where you feel safe.",
    ...
    fearful: {name:"Fearful-avoidant", essence:"You long to be close, yet fear being seen.",
