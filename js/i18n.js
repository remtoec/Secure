...
zh: {
  ...
  "result.snapshotNoteGeneral": "這是此刻的位置，會隨經驗移動。整體版量度你對關係的整體想法；與某一個人測出來的位置，可以跟它不同——書中正是建議把兩者放在一起比較。",
...
en: {
  ...
  "result.snapshotNoteGeneral": "A position, taken today; it moves with experience. The general questionnaire reads your overall attitude to relationships — your position with any one person can differ from it, and comparing the two is exactly what the book suggests.",
